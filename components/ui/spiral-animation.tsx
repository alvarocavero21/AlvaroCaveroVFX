...
class AnimationController {
    ...
    public render() {
        ...
        // Transparent background so the site bg shows through
...
class Star {
    ...
    render(p: number, controller: AnimationController) {
        ...
        if (q > 0) {
            ...
            // Access private fields via bracket notation for 3D projection
    ...
    useEffect(() => {
        ...
        const observer = new IntersectionObserver(
            ([entry]) => {
                ...
                entry.isIntersecting ? animationRef.current.resume() : animationRef.current.pause()
            },
            { threshold: 0.1 }
        )
